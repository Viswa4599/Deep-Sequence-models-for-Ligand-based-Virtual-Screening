...
def main():
    ...
    parser.add_argument('--in_path', '-i', type=str, default='data/GDB17.smi', help='input file')
    parser.add_argument('--out_path_1', '-o1', type=str, default='data/gdb17_train.csv', help='output file (train)')
    parser.add_argument('--out_path_2', '-o2', type=str, default='data/gdb17_test.csv', help='output file (test)')
